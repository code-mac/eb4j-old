...
public interface SubscriberStore {
    ...
    Collection<Subscriber> subscribersOf(Event event);

    /**
     * Determine whether the store have specified subscriber.
     *
     * @param subscriber the subscriber to determine
     * @return true, the store have specified subscriber; otherwise false
     */
